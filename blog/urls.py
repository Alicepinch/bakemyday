...
urlpatterns = [
    ...
    path('add-comment/<int:blogpost_id>/', views.add_comment, name='add_comment'),
    path('delete-blogcomment/<int:blogcomment_id>/', views.delete_comment, name='delete_blogcomment'),
]