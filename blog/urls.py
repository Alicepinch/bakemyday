...
urlpatterns = [
    ...
    path('add-blogcomment/<int:blogpost_id>/', views.add_blogcomment, name='add_blogcomment'),
    path('delete-blogcomment/<int:blogcomment_id>/', views.delete_blogcomment, name='delete_blogcomment'),
    path('edit-blogcomment/<int:blogcomment_id>/', views.edit_blogcomment, name='edit_blogcomment'),
]